...
#include "UAvatar/Public/MyActor.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	UAVATAR_API UClass* Z_Construct_UClass_AMyActor_NoRegister();
	UAVATAR_API UClass* Z_Construct_UClass_AMyActor();
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	UPackage* Z_Construct_UPackage__Script_UAvatar();
// End Cross Module References
	...
	UObject* (*const Z_Construct_UClass_AMyActor_Statics::DependentSingletons[])() = {
		...
		(UObject* (*)())Z_Construct_UPackage__Script_UAvatar,
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AMyActor, 2602672813);
	template<> UAVATAR_API UClass* StaticClass<AMyActor>()
	{
		return AMyActor::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AMyActor(Z_Construct_UClass_AMyActor, &AMyActor::StaticClass, TEXT("/Script/UAvatar"), TEXT("AMyActor"), false, nullptr, nullptr, nullptr);
